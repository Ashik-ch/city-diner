...
const Home = () => {
  ...
  const bgImg = "https://i.pinimg.com/736x/cc/bb/d9/ccbbd9809899b816a35977f8f083e8a5.jpg"
  useEffect(() => {
    const move = (e) => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white">
      ...
      <div
        className="absolute inset-0 z-0 bg-center bg-cover bg-no-repeat blur-lg fixed"
        ...
        <div className="mx-auto grid min-h-screen w-full max-w-7xl items-center gap-10 px-4 py-12 lg:grid-cols-2">
          ...
          >
            ...
            <MotionDiv variants={fadeUp} className="flex flex-wrap gap-3">
              <button className="flex items-center gap-2 rounded-full bg-gradient-to-r from-red-900 to-purple-900 px-6 py-3 font-semibold text-white shadow-lg transition hover:-translate-y-0.5">
